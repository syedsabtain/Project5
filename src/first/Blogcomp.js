...
const Blogg = () => {
    ...
    const { ref } = useWebAnimations({
        ...
        timing: { duration: 7000, iterations: Infinity, easing: 'ease-in-out' },
      });
      one = ref;
    //   one ends

      const second = useWebAnimations({

        keyframes: [{transform:'translate(0,0)',opacity:1},
            { transform: "translate(200px,100px)",opacity:0},
                     {transform: 'translate(0,0)',opacity:1},                    
        ],
        timing: { duration: 7000, iterations: Infinity, easing: 'ease-in-out' },
      });
    ...
    //   second ends
      ...
      const fourth = useWebAnimations({

        keyframes: [{transform:"translate(0,0)",opacity:1},
            { transform: "translate(-500px,-300px)",opacity:0},
                     {transform: 'translate(0,0)',opacity:1},                    
        ],
        timing: { duration: 7000, iterations: Infinity, easing: 'ease-in-out' },
      });
    ...
    timing: { duration: 7000, iterations: Infinity, easing: 'ease-in-out' },
      ...
      const seventh = useWebAnimations({

        keyframes: [{transform:'translate(0,0)',opacity:1},
            { transform: "translate(-500px,-100px)",opacity:0},
                     {transform: 'translate(0,0)',opacity:1},                    
        ],
        timing: { duration: 7000, iterations: Infinity, easing: 'ease-in-out' },
      });
    ...
    timing: { duration: 7000, iterations: Infinity, easing: 'ease-in-out' },
      ...
      const ninth = useWebAnimations({

        keyframes: [{transform:'translate(0,0)',opacity:1},
            { transform: "translate(10px,20px)",opacity:0},
                     {transform: 'translate(0,0)',opacity:1},                    
        ],
        timing: { duration: 7000, iterations: Infinity, easing: 'ease-in-out' },
      });
    ...
    const svgmain = useWebAnimations({
    ...
    return (
		...
		c135.3,18.2,270.5,36.4,405.8,54.7C813.6,841.8,815.9,934.2,818.1,1026.7z"/>
                ...
                <g id="Layer_8"></g>
                <line className="st16" x1="811.3" y1="749.3" x2="820.1" y2="1024.8"/>
                <path className="st16" d="M811.9,749.1c2.7,90.6,5.4,181.2,8.1,271.8"/>
                <path
                    className="st17"
